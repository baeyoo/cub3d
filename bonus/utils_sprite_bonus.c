...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   utils_sprite_bonus.c                               :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: mobrycki <marvin@42.fr>                    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/04/30 18:28:00 by mobrycki          #+#    #+#             */
/*   Updated: 2021/04/30 18:28:01 by mobrycki         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	readtwo(t_vars *vars)
{
	...
	{
		if (ft_strcomp(vars->mappa.mappa[i], "234"))
		{
			vars->sprite[j].obj = 0;
			if (vars->mappa.mappa[i] == '3')
				vars->sprite[j].obj = 1;
			if (vars->mappa.mappa[i] == '4')
				vars->sprite[j].obj = 3;
...
void	ics(t_vars *vars, int i, int x, int a)
{
	if (x >= 0)
	{
		...
		else if (vars->sprite[i].obj == 1)
			draw_snacks(vars, i, x, a);
		else if (vars->sprite[i].obj == 4)
			draw_macchine(vars, i, x, a);
	}
}
